...
_SPRINT_TOPICS = (
    ["как идёт спринт", "на какой теме сейчас", "где застрял", "нужен ли созвон или мок"],
    ["собеседования", "рынок труда", "офферы", "отклики и резюме"],
)
...
_TOPICS = {
    ...
    "sprint4": (
        ["как идёт 4-й спринт", "готово ли резюме и легенда", "начал ли общаться с HR"],
        ["наличие офферов", "итоги собеседований"],
    ),
    "interviews": (
